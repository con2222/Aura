...
UWaitCooldownChange* UWaitCooldownChange::WaitForCooldownChange(class UAbilitySystemComponent* AbilitySystemComponent,
	const FGameplayTag& InCooldownTag)
{
	...
	//When cooldown effect has been applied
...
void UWaitCooldownChange::OnActiveEffectAdded(UAbilitySystemComponent* TargetASC,
	const struct FGameplayEffectSpec& SpecApplied, struct FActiveGameplayEffectHandle ActiveEffectHandle)
{
